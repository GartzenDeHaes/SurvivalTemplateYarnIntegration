...
{
	// UI View Model
	public sealed class DialogueInteractionUI : MonoBehaviour, IInteractableInfoDisplayer
	{
		public IEnumerable<Type> HoverableTypes => m_InteractableTypes;
		private static readonly Type[] m_InteractableTypes = { typeof(IInteractableCharacter) };
